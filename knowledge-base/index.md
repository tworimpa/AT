...
- [Agent Plugins Spec 고정 ToolVersion 프로필](./tools/agent-plugins-spec.md): Agent Skills+MCP portable package, manifest/discovery/failure와 containment 경계
...
- [2026-08-15 GitHub stars 도구 선별 실행 기록](./execution-records/2026-08-15-github-stars-tool-selection.md): 공개 스타 1,048개 triage, 네 후보 manifest-only 등록과 보류 근거
- [2026-08-15 Agent Plugins Spec 조사 실행 기록](./execution-records/2026-08-15-agent-plugins-spec-research.md): 후속 선택, published v1.0.0 fixed commit 등록과 `V2/P0` 경계
